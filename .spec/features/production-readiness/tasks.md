...
## T-001 — Tornar o build reproduzível e contínuo [pendente]
...
## T-002 — Corrigir e testar o contrato de criação de produtos [pendente]
...
## T-003 — Externalizar e limitar a integração de pagamentos [pendente]
